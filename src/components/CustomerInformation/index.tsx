...
import { CustomerInfoContainer, HeadingDiv, HeaderDiv } from './style';
...
> {
  ...
  handleInputOnChange =
    (field: CustomerInformationField) =>
  ...
  render() {
    ...
    return (
      <CustomerInfoContainer>
        <HeadingDiv>Billing Information</HeadingDiv>
        ...
        >
          <HeaderDiv>Thank you! We have received your order!</HeaderDiv>
          <p>Please wait 5 to 10 business days for your items to arrived.</p>
          <Button type="primary" onClick={this.handleShopMoreClick}>
            Shop More
          </Button>
        </Modal>
      </CustomerInfoContainer>
